// Hockey Equipment NFT

// Hockey Equipment provides stat multipliers for a Player.
...
pub contract HockeyEquipment: NonFungibleToken {
    ...
    // Meta stores the metadata for a piece of HockeyEquipment
    pub struct Meta {
        pub let type: String
        pub let rarity: Int
        pub let stat: String
    ...
    pub resource Equipminter {
        pub fun mintEquip(recipient: &{NonFungibleToken.CollectionPublic}, type: String, rarity: Int, stat: String, multiplier: UFix64) {
            ...
            let tokenID = HockeyEquipment.totalSupply
            ...
            HockeyEquipment.totalSupply = HockeyEquipment.totalSupply + 1 as UInt64
